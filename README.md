...
|----------------------|--------------------------------------------------|------------------|
| ![**Marketing / Funnel Diagram**](https://github.com/sazhirom/Tableau/blob/main/marketing.png?raw=true)  | Dashboard featuring a Marketing Funnel, custom filters, dynamic sets, a lot of conditional formatting, list based filters and so on.   | [**Link to Tableau Public**](https://public.tableau.com/app/profile/george.romanov/viz/MarketingDashboard_17453783792250/Dashboard1) |
